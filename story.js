const story = {
    ...
    scene22_discovery: {
        ...
        dialogue: 'الن: «جیمی... اینجا فقط یکی نیست...» ۲۰ جسد. با ۹ تای قبلی می‌شه ۲۹ تا. همه زن. قاتل هیچ‌وقت متوقف نشده بود. فقط جای دیگه‌ای دفن می‌کرد.',
    ...
    scene24_doctor2: {
        ...
        dialogue: '«این اجساد مال بازهٔ ۸ ساله. همه زن. بیشترشون فاحشه. ۶ تاشون ناشناسن. صورتشون داغون شده یا سر ندارن. یه چیز مشترک: طناب ۸ میلی‌متری روی همه.»',
        choices: [
    ...
    scene25_coffee: {
        ...
        dialogue: 'پدر: «بهتون خوش می‌گذره؟ قهوه می‌خورین؟ دختر من مرده. ۲۹ تا آدم دیگه مردن. لعنت بهتون.» کافه ساکت می‌شه. همه نگاه می‌کنن.',
        choices: [
    ...
    scene28_plan: {
        location: 'کلانتری — شب',
        text: 'کیسی رو دارین ولی قاتل نیست. می‌دونین قاتل لاغره، مو مشکی، سر به زیر، و از بیل استفاده می‌کرده.',
        dialogue: 'الن: «هیچ مظنونی نداریم. ولی می‌دونیم چی شکلیه. حالا چی؟»',
        choices: [
            { label: '۱. مأمور زن با لباس فاحشه می‌فرستیم تو جاده. از دور مراقبشیم.', next: 'scene29_undercover' },
            { label: '۲. اطراف جلگه رو تحت نظر می‌گیریم. قاتل به اونجا عادت کرده.', next: 'scene29_valley' },
    ...
    scene29_valley: {
        ...
        dialogue: 'وقت تلف کردی. بهت یه شانس داده می‌شه: می‌خوای برگردی و مسیر درست رو انتخاب کنی؟',
        choices: [
            { label: '۱. آره. برمی‌گردم و مأمور فاحشه رو می‌فرستم.', next: 'scene29_undercover' },
            { label: '۲. نه. به راه خودم ادامه می‌دم.', next: 'scene30_failed' }
        ],
    ...
    scene29_undercover: {
        location: 'جاده — شب — تاریک',
        text: 'مأمور زن داوطلب می‌شه. می‌ره کنار جاده. شما از دور مراقبید.',
        dialogue: 'کامیون قرمز وایمیسته. مرد مو مشکی لاغر. مأمورا از تاریکی می‌زنن بیرون. دستگیر می‌شه.',
        choices: [{ label: 'ادامه...', next: 'scene30_caught' }],
        onLoad: function() { gameState.stress -= 1; }
    },
